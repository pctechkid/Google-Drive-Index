...
function nav(path) {
  ...
  <a class="navbar-brand" href="/${cur}:/">${UI.logo_image ? '<img border="0" alt="'+UI.company_name+'" src="'+UI.logo_link_name+'" height="30px">' : '<i class="fa fa-cloud"></i> + UI.logo_link_name}'</a>
