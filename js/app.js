...
function nav(path) {
  ...
  <i class="fa fa-cloud">&nbsp;&nbsp;&nbsp;</i><a class="navbar-brand" href="/${cur}:/">${UI.logo_image ? '<img border="0" alt="'+UI.company_name+'" src="'+UI.logo_link_name+'" height="30px">' : UI.logo_link_name}</a>
